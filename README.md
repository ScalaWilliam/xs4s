...
```sbt
libraryDependencies += "com.scalawilliam" %% "xs4s-core" % "0.8.2"
libraryDependencies += "com.scalawilliam" %% "xs4s-fs2" % "0.8.2"
libraryDependencies += "com.scalawilliam" %% "xs4s-zio" % "0.8.2"
```
